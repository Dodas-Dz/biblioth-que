    ...
    <div class="row">
      <div class="col-md-3 mb-4 " id="kid_novel">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/wonderbookcover.png" alt="courses" />
          <div class="card-body">
            <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Wonder</h5>
            <a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#wnd">kid novel
            </a>
              ...
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h4 class="modal-title">Wonder</h4>
      ...
      <div class="col-md-3 mb-4 " id="islamic1">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/iternalchallengebook.png" alt="courses" />
          ...
          <div class="card-body">
            ...
            <a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#Ech">islamic
            </a>
      ...
      <div class="col-md-3 mb-4 " id="islamic2">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/thechoicebook.png" alt="courses" />
          <div class="card-body">
            ...
            <a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#chc">islamic
      ...
      <div class="col-md-3 mb-4 " id="manga">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/deamonslayermanga.png" alt="courses" />
          <div class="card-body">
            <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Demon Slayer Chapter 1</h5><a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#ds">Manga
      ...
      <div class="col-md-3 mb-4" id="novel">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/harrypotterbook.png" alt="courses" />
          <div class="card-body">
            <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Harry Potter</h5><a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#Hp1">Novel
      ...
      <div class="col-md-3 mb-4" id="kids">
        <div class="card h-100"><img class="card-img-top w-100" src="assetsU/img/gallery/dragonlovetacos.png" alt="courses" />
          <div class="card-body">
            ...
            <a href="#!" class="text-muted fs--1 stretched-link text-decoration-none " data-bs-toggle="modal" data-bs-target="#Dlt">Kids
