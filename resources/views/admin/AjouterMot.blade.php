...
color: red;
                              ...
                              <input id="livre_id" type="text" class="form-control form-little-squirrel-control form-control-sm" name="livre_id" value="" placeholder="Entrer ID du livre" required  autofocus>
                              <i class="fas fa-key input-box-icon mt-3" style="color:rgb(73, 73, 73)"></i>
                             </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-auto">
                    <div class="row align-items-center mb-3 mt-3">
                     ...
                     <form class="needs-validation" method="POST" action="{{ route('Ajouter_mot') }}" novalidate>
