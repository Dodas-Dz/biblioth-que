...
<button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation" data-target="#navigation-example">
  ...
  <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="{{Route('recherche')}}">Livre</a>
                <a class="dropdown-item" href="{{Route('Apropos')}}">A propos</a>
                <a class="dropdown-item" href="{{Route('Emprente')}}">Mes livre</a>
          ...
          Menu
            ...
            <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton" >
               ...
               <a class="nav-link dropdown-toggle" href="#" role="button" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <ul>
                <li>  <a class="dropdown-item" href="{{Route('homee')}}">Accueil</a></li>
                 <li> <a class="dropdown-item" href="{{Route('recherche')}}">Livre</a></li>
                <li>  <a class="dropdown-item" href="{{Route('Apropos')}}">A propos</a></li>
                 <li> <a class="dropdown-item" href="{{Route('Emprente')}}">Mes livre</a></li>
